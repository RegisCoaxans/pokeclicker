...
export default class GenericDeal {
    ...
    public static generateDeals() {
        ...
        GenericDeal.list.LaFFTradePlace = ko.observableArray([
            ...
            new GenericDeal({
                costs: [{ type: DealCostOrProfitType.Item, item: ItemList.Sweet_Heart, amount: 3 }],
                profits: [{ type: DealCostOrProfitType.Item, item: ItemList.Loveball, amount: 1 }],
                visibleRequirement: new SpecialEventRequirement('Love at First Flight'),
            }),
            new GenericDeal({
                costs : [{ type: DealCostOrProfitType.Item, item: ItemList.Sweet_Heart, amount: 150 }],
                profits : [{ type: DealCostOrProfitType.Item, item: ItemList['Kecleon (In Love)'], amount: 1, hidePlayerInventory: true }],
                visibleRequirement: new MultiRequirement([new ObtainedPokemonRequirement('Inteleon', true), new SpecialEventRequirement('Love at First Flight')]),
            }),
            new GenericDeal({
                costs: [{ type: DealCostOrProfitType.Item, item: ItemList.Sweet_Heart, amount: 100 }],
                profits: [{ type: DealCostOrProfitType.Item, item: ItemList['Kecleon (In Love)'], amount: 1, hidePlayerInventory: true }],
                visibleRequirement: new MultiRequirement([new ObtainedPokemonRequirement('Inteleon'), new SpecialEventRequirement('Love at First Flight')]),
            }),
        ]);
    }
}
